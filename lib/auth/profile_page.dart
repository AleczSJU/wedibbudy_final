...
class ProfilePage extends StatefulWidget {
   final String title;
  const ProfilePage({this.title = 'Wedibuddy'});
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  var model;
  void initState() {
    model= json.decode(Constant.PROFILEJSON);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
     appBar: _buildAppBar(),
     body: _buildBody(),
     drawer: drawer.DrawerWidget.buildDrawer(context,"Profile"),
    );
  }
 ...
 String getDob(model) {
    ...
    Widget accountInfo=new Container(child: Padding(
      ...
      child: new Column(children: <Widget>[
        ...
        getRow("DOB", getDob(model).toString()),
